            ...
            <header className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                <div className="space-y-1">
                    ...
                    >
                        ...
                        <span className="uppercase text-xs tracking-widest">Barber Management</span>
                    </motion.div>
                    <h1 className="text-4xl font-black text-gray-900">{date}</h1>
                    <div className="flex items-center gap-3 text-gray-500">
                        <div className="flex items-center gap-1.5 bg-gray-100 px-3 py-1 rounded-full text-sm font-medium">
                            <Clock size={14} className="text-indigo-500" />
                            {hour}
                        </div>
                        <p className="text-sm">Manage your daily schedule</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white border border-gray-200 text-gray-700 text-sm font-bold shadow-sm hover:bg-gray-50 transition-all active:scale-95"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-indigo-600 text-white text-sm font-bold shadow-lg shadow-indigo-200 hover:bg-indigo-700 transition-all active:scale-95"
                    >
                        <Scissors size={18} />
                        Services
                    </button>
