...
export default function SlotCard({
  ...
  // Cargar servicios solo cuando se abre la tarjeta
  useEffect(() => {
                      ...
                      services.map((s) => (
                        ...
                        >
                          <div className="text-left min-w-0 flex-1">
                            <p
                              className={`text-sm font-black truncate ${selectedService === s.id ? "text-indigo-900" : "text-gray-700"
                                }`}
                            >
                              {s.name}
                            </p>
